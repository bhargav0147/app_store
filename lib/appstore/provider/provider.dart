import 'package:app_store/appstore/model/modelclass.dart';
import 'package:flutter/widgets.dart';

class AppProvider extends ChangeNotifier
{
  List<AppModel> gameinfo = [
    AppModel(
  ...
  List<AppModel> offerinfo = [
    AppModel(
      firstimage: "assets/images/today/1.jpg",
    ),
    AppModel(
      firstimage: "assets/images/today/2.jpg",
    )
  ];
}
